...
def Draw_Sucesion_Monotona(n , intervalo_x = [0,6], intervalo_y = [0,1], Plot_dark = True, ocultar_numeros = False, ocultar_etiquetas = False, ocultar_funciones = False, ocultar_cota = False, tam_fuentes = 12):
    ...
    if not ocultar_cota:
        ax.hlines(1,0,n+10, color='magenta' if Plot_dark else 'red', linestyle=':')
...
def main():
    ...
    st.set_page_config(page_title="Sucesión Monótona Acotada", layout="wide", initial_sidebar_state='expanded', page_icon=':material/line_axis:')#, menu_items={'Get Help': 'https://www.extremelycoolapp.com/help','Report a bug': "https://www.extremelycoolapp.com/bug",'About': "# This is a header. This is an *extremely* cool app!"})
