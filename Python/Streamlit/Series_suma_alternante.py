...
def main():
  ...
  st.set_page_config(page_title="Visualización 1D de una serie", layout="wide", initial_sidebar_state='expanded', page_icon=':material/line_axis:')#, menu_items={'Get Help': 'https://www.extremelycoolapp.com/help','Report a bug': "https://www.extremelycoolapp.com/bug",'About': "# This is a header. This is an *extremely* cool app!"})

  #! Titulo
  st.title('Visualización 1D de una serie')
  ...
  with st.spinner('Generando gráfico...'):
    fig = Draw_Sucesion_1D(n , intervalo_x, solo_ultimo=False, Plot_dark=Plot_dark, ocultar_etiquetas=ocultar_etiquetas)
    st.pyplot(fig)
