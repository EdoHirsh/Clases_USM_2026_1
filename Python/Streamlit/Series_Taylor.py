...
def Draw_Taylor(n, intervalo_x=[-10,10], intervalo_y=[-2,2], intervalo_x_graf=[-10.1,10.1], intervalo_y_graf=[-2.1,2.1], Plot_dark=False, tam_fuentes=12):
    Res_EjeX=1000
    N_Max=n
...
def main():
    ...
    with st.spinner('Generando gráfico...'):
        fig , _ = Draw_Taylor(n, intervalo_x=intervalo_x, intervalo_y=intervalo_y, Plot_dark=Plot_dark, tam_fuentes=tam_fuentes)
        st.pyplot(fig)
