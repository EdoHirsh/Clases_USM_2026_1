...
\begin{frame}
  ...
  \vspace{-5mm}
  \begin{center}
    \hspace*{-10mm}\includegraphics[scale=0.4]{./imagenes/Sucesion_1D.png}
  \end{center}
  \onslide<2->{
    \vspace{-2mm}
...
\begin{frame}{Ejemplos}
  ...
  \begin{enumerate}[<+->]
    \item $\displaystyle\lim_{n\to\infty}\dfrac{2n+5}{3n+1}$\\
    \item $\displaystyle\lim_{n\to\infty}\dfrac{3n+2}{n^2+1}$\\
