...
\begin{frame}
  ...
  \vspace{-5mm}
  \begin{center}
    \hspace*{-10mm}\href{https://graficosucesiones1d.streamlit.app/}{\includegraphics[scale=0.4]{./imagenes/Sucesion_1D.png}}
  \end{center}
  \onslide<2->{
    \vspace{-2mm}
    ...
    \vspace{-5mm}
    \begin{center}
      \href{https://graficosucesiones2d.streamlit.app/}{\includegraphics[scale=0.4]{./imagenes/Sucesion_2D.png}}
    \end{center}
  }
\end{frame}
...
\begin{frame}
  ...
  \onslide<2->{
    \begin{center}
      \href{https://sucesionesteoremasandwich.streamlit.app/}{\includegraphics[scale=0.4]{./imagenes/Teorema_Sandwich.png}}
    \end{center}
  }
\end{frame}
...
\begin{frame}
  \begin{eg}
    ...
    \vspace{-3mm}
    \begin{center}
      \href{https://sucesionesmonotonaacotada.streamlit.app/}{\includegraphics[scale=0.4]{./imagenes/Sucesion_Creciente_Acotada.png}}
    \end{center}
  \end{eg}
\end{frame}
...
\begin{frame}
  ...
  \onslide<2->{
    \vspace{-0.7cm}
    \begin{center}
      \href{https://seriescriteriointegral.streamlit.app/}{\includegraphics[scale=0.33]{./imagenes/CriterioIntegral_Sup_Inf.png}}
    \end{center}
  }
\end{frame}
...
\begin{frame}
  Gráficamente el criterio de comparación ordinaria se puede representar como
  % \vspace{-5mm}
  \begin{center}
    \href{https://seriescriteriocomparacion.streamlit.app/}{\includegraphics[scale=0.33]{./imagenes/Criterio_Comparacion.png}}
  \end{center}
\end{frame}
...
\begin{frame}
  ...
  \end{thm}
  \onslide<2->{
    Gráficamente el error de una serie alternante se puede representar como
    \vspace{-3mm}
    \begin{center}
      \hspace*{-18mm}\href{https://seriessumaalternante.streamlit.app/}{\includegraphics[scale=0.45]{./imagenes/Serie_Alternante.png}}
    \end{center}
    \vspace{-6mm}
  }
  \onslide<3->{
...
\begin{frame}
  \begin{center}
    \begin{figure}[ht]
      \href{https://seriestaylorcos.streamlit.app/}{\includegraphics[scale=0.35]{./imagenes/TaylorCos_n20.png}}
