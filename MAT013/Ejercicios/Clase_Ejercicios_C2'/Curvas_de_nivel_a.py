...
def main():
  ...
  plt.clabel(contours,inline=1,fontsize=10,manual=[(1/np.sqrt(2),1/np.sqrt(2)),(1,1),(np.sqrt(3)/np.sqrt(2),np.sqrt(3)/np.sqrt(2)),(2/np.sqrt(2),2/np.sqrt(2)),(np.sqrt(5)/np.sqrt(2),np.sqrt(5)/np.sqrt(2))])
